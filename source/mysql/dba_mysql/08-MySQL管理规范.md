...
|No.|数据库文档模板|
|:--|:--|
|1|[业务信息模板](/mysql/dba_mysql/08-MySQL管理规范/业务信息模板.html)|
|2|[实例列表模板](/mysql/dba_mysql/08-MySQL管理规范/实例列表模板.html)|
|3|[服务器明细模板](/mysql/dba_mysql/08-MySQL管理规范/服务器明细模板.html)|
|4|[应用明细模板](/mysql/dba_mysql/08-MySQL管理规范/应用明细模板.html)|
|5|[迁移报告模板](/mysql/dba_mysql/08-MySQL管理规范/迁移报告模板.html)|
|6|[迁移方案模板](/mysql/dba_mysql/08-MySQL管理规范/迁移方案模板.html)|
|7|[排查报告模板](/mysql/dba_mysql/08-MySQL管理规范/排查报告模板.html)|
|8|[优化建议模板](/mysql/dba_mysql/08-MySQL管理规范/优化建议模板.html)|
|9|[自建MySQL逻辑备份模板](/mysql/dba_mysql/08-MySQL管理规范/自建MySQL逻辑备份模板.html)|
|10|[自建MySQL物理备份模板](/mysql/dba_mysql/08-MySQL管理规范/自建MySQL物理备份模板.html)|
  
# 数据库技术规范

|No.|数据库技术规范|
|:--|:--|
|1| [文档归档要求](/mysql/dba_mysql/08-MySQL管理规范/文档归档要求.html)|
|2| [业务数据库对接规范](/mysql/dba_mysql/08-MySQL管理规范/业务数据库对接规范.html)|
|3| [数据库安装部署规范](/mysql/dba_mysql/08-MySQL管理规范/数据库安装部署规范.html)|
|4| [数据库备份规范](/mysql/dba_mysql/08-MySQL管理规范/数据库备份规范.html)|
|5| [数据库安全规范](/mysql/dba_mysql/08-MySQL管理规范/数据库安全规范.html)|
|6| [数据库归档规范](/mysql/dba_mysql/08-MySQL管理规范/数据库归档规范.html)|
|7| [数据库监控规范](/mysql/dba_mysql/08-MySQL管理规范/数据库监控规范.html)|
|8| [数据库迁移规范](/mysql/dba_mysql/08-MySQL管理规范/数据库迁移规范.html)|
|9| [数据库升级规范](/mysql/dba_mysql/08-MySQL管理规范/数据库升级规范.html)|
|10| [阿里云资产标签规范](/mysql/dba_mysql/08-MySQL管理规范/阿里云资产标签规范.html)|
